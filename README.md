The purpose of this project was to build a simple distributed application. The travel application sets up a client communication between multiple servers to book a trip.
